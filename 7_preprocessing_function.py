...
preprocess_prompt = ChatPromptTemplate.from_messages([
    ("system", "You are a data cleaning expert. Based on the dataset summary, info, and descriptive analysis (such as mean, median, std, min, max, and value distributions), generate a pandas-only data cleaning script. Do NOT use sklearn or any external libraries. Your cleaning script should identify and handle missing values, duplicates, outliers, and inconsistent data formats using only pandas."),
