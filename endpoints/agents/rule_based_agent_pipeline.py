...
class RuleBasedAgent:
    ...
    def determine_action(self, user_input: str, retry_count: int = 0) -> AgentAction:
        """Determine the appropriate action with timeout and retry support"""
        ...
        # Initialize tool input with timeout
        tool_input = {
            "data": user_input,
            "timeout_sec": 10 - retry_count * 2  # Reduce timeout on retries
        }
        ...
        if intent["tag"] in ["correlation_analysis", "regression_analysis"]:
            ...
            # Add specific handling for price analysis
            tool_input["timeout_sec"] = 15  # Give more time for price analysis
